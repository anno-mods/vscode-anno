...
!!! warning "It's recommended to use the Blender plugin instead."

    The import functionality predates the Blender plugin.
    Use that instead:

    - [Blender Plugin for Anno 117](https://github.com/anno-mods/Blender-Anno-117)
    - [Blender Plugin for Anno 1800](https://github.com/anno-mods/Blender-Anno-1800)
